...
public class DetailInteractor {
    ...
    private DetailInteractor(){ realm = Realm.getDefaultInstance(); }

    private static DetailInteractor instance;

    public static DetailInteractor init() { return  new DetailInteractor(); }
    ...
    public void loadDetailOrganization(String orgId){
        ...
        city = realm.where(City.class).equalTo("id",organization.getRegionId()).findFirst().getName();
    ...
    public List<CurrencyModel> getModelList() { return  modelList; }
}
